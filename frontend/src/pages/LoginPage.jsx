...
const ERROR_MESSAGES = {
  please_retry:   "Server was waking up — please try again now, it'll work!",
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0d0d0d] px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[420px] anim-fade-up">
        <div className="flex justify-center mb-6 anim-fade-in delay-1">
          <span className="text-[0.65rem] font-semibold tracking-[0.3em] text-[#ff3c3c] border border-[rgba(255,60,60,0.2)] bg-[rgba(255,60,60,0.07)] px-4 py-1.5 rounded-full">
            ANONYMOUS
          </span>
        </div>
        ...
        {/* Retry error banner — only shown when redirected back with ?error= */}
        {errorMsg && (
          <div className="mb-6 px-4 py-3 rounded-lg bg-[rgba(255,60,60,0.08)] border border-[rgba(255,60,60,0.2)] text-[#ff6b6b] text-xs text-center leading-relaxed">
            {errorMsg}
          </div>
        )}
