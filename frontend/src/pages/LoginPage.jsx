const LoginPage = () => {
  const handleGoogleLogin = () => {
    // VITE_API_URL must be set to the backend URL in Render's frontend env vars.
    // e.g. https://anonymous-confession-wall-7x6t.onrender.com
    //
    // When VITE_API_URL is empty, this becomes just "/api/auth/google" which
    // hits the frontend's Nginx — not the backend — and OAuth never starts.
